...
class GoatDetailsPage extends StatefulWidget {
  const GoatDetailsPage({Key? key}) : super(key: key);
        ...
        child: Column(
          ...
          children: [
            ...
            (_goatstage == 'Adult')
                ? Column(
                    children: [
                      ...
                      (gender_status == 2 && _goatstage == 'Adult')
                          ? Container(
                              padding: const EdgeInsets.all(8.0),
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                ...
                : Container(),
            (milking_status == 1 && _goatstage == 'Adult')
                ? (gender_status == 2 && _goatstage == 'Adult')
                    ? Container(
            ...
            (gender_status == 2 && _goatstage == 'Adult')
                ...
                : Container(),
            (gender_status == 2 && _goatstage == 'Adult' && fetal_status == 1)
                ? Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Container(
