...
class selling_Detail extends StatefulWidget {
  @override
  _selling_Detail createState() => _selling_Detail();
}

class _selling_Detail extends State<selling_Detail> {
  ...
  final mylactation = TextEditingController();
  final milking_perday = TextEditingController();
  final pre_time = TextEditingController();
  final myheight = TextEditingController();
  final mynote = TextEditingController();
...
Text(
  ...
  void sellDetails()async{
    ...
    var data = {
      ...
      "phase": _selectedStage,
      "milking_status": milking_status,
      "fetal_status": fetal_status,
      "age": myage.text,
      "lactation": mylactation.text,
      "price": myprice.text,
      "is_possibale_change": _isPriceChangePossible,
      "vaccinated": _isVaccinationGiven,
      "milk_per_day": milking_perday.text,
      "note": mynote.text,
      "pregnancy_time": pre_time.text
    };
